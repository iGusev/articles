...
Каждый мажорный релиз PHP добавляет ряд новых возможностей, некоторые из которых действительно имеет значение. Для PHP 5.3 - это были пространства имен и анонимные функции. Для PHP 5.4 - трейты. Для PHP 5.5 - генераторы. Для 5.6 - списки аргументов переменной длины.
